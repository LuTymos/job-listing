...
@font-face {
    ...
    src: local("League Spartan Regular"), local("LeagueSpartanRegular"), url(${LeagueSpartanRegular});
}
@font-face {
    font-family: 'LeagueSpartanMedium';
    src: local("League Spartan Medium"), local("LeagueSpartanMedium"), url(${LeagueSpartanMedium});
}
@font-face {
    font-family: 'LeagueSpartanBold';
    src: local("League Spartan Bold"), local("LeagueSpartanBold"), url(${LeagueSpartanBold});
}
